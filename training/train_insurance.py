...
class Insurance_claim_prediction():
    ...
    def create_pipeline(self):
        ...
        X = final_df[["age","sex","bmi","children","smoker","region","charges"]]
        y = final_df[["insuranceclaim"]]
    ...
    def create_outputs(self, y_true, y_pred, X_test, name):
        ...
        '''
        pred_output = {"Actual claim " : y_true['insuranceclaim'].values, "Predicted claim": y_pred['insuranceclaim'].values}        
    ...
    def validate(self, y_true, y_pred, X_test):
        ...
        y_pred_df = pd.DataFrame(y_pred, columns = ['predicted_insuranceclaim'])
        self.create_outputs(y_true, y_pred_df,X_test, "predictions")
        self.run.tag("InsuranceClaimPredictorFinalRun")        
...
if __name__ == "__main__":
    ...
    iris_classifier = Insurance_claim_prediction((args)
